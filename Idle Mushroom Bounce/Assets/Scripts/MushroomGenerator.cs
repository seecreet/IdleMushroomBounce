...
public class MushroomGenerator : MonoBehaviour
{
    ...
    public GameObject m_generatedMushroom;
    public GameObject m_currentMushroom;
    ...
    internal void GenerateMushroom(object m_isNewMushroom)
    {
        throw new NotImplementedException();
    }

    public void GenerateMushroom(bool isNewMushroom)
    {
        if (isNewMushroom)
        {
            m_currentMushroom = Instantiate(m_generatedMushroom, Vector3.zero, Quaternion.identity);
            m_mushLine = m_currentMushroom.GetComponent<LineRenderer>();
            m_mushFilter = m_currentMushroom.GetComponent<MeshFilter>();
            m_mushMesh = new Mesh();
            ...
            m_pointCounter = 0;
            m_isCapInstantiated = false;
            //m_generatedMushroom.transform.position = Vector3.zero;
        }
